...
public class AccessCodeController extends BaseController {
    ...
    public BaseModelAndView authorize(HttpServletRequest request, HttpSession session, BaseModelAndView bmv) throws OAuthSystemException, IOException, OAuthProblemException {
        try {
            ...
            bmv.addObject("client_id", oAuthAuthzRequest.getClientId()); //客户端id
